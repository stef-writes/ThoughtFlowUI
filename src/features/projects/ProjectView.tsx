...
const mockWorkspaces = [
  {
    ...
    description: 'Economic analysis and market forecasting',
    loci: 3,
  ...
  },
  {
    id: '2',
    name: 'Cryptocurrency',
    description: 'Digital currency trading and analysis',
    loci: 4,
  ...
  },
  {
    ...
    description: 'Personal financial management and budgeting tools',
    loci: 2,
